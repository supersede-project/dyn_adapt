...
BUILD_ID=dontKillMe nohup mvn spring-boot:run -Drun.arguments="--server.port=8090,--logging.file=./log/adapter.log" -Dsupersede.if.properties=if.production.properties &
