...
public class InputParser {
	...
	public static final String [] keys = {"Adresse","Bundesland", "Ort" , "PLZ", "klimaaktiv Gebäude","klimaaktiv Deklaration", "Nutzfläche", "Objekttyp", "Wohneinheiten/Nutzeinheiten", "Energie und Gebäudetechnik", "Heizlast", "Fern- oder Nahwärme RH", "Fern- oder Nahwärme WW", "Art des Lüftungssystems", "Warmwasserbereitung", "OI3 Index (OI3TGH, BGF)", "HFKW freie Dämmstoffe", "HFKW freie Montageschäume etc.", "Nachweis für Sommertauglichkeit", "Rechtsform", "Baubeginn", "Fertigstellung", "Heizwärmebedarf (HWB)", "Primärenergiebedarf (PHPP)", "Firmenname/Name"}; //, "CO2 Emission", "OI3 Index", "Blower Door Test"}; 
