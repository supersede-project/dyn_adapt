...
public final class RealizationsQuerySpecification extends BaseGeneratedEMFQuerySpecification<RealizationsMatcher> {
  ...
  @Override
  public RealizationsMatcher instantiate() throws ViatraQueryException {
    return RealizationsMatcher.create();
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_pClient, parameter_pSupplier);
    
    @Override
    public String getFullyQualifiedName() {
      return "patterns.realizations";
    }
