...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.usecases.patterns.classes pattern,
...
public class ClassesMatcher extends BaseMatcher<ClassesMatch> {
  ...
  public static ClassesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = (ClassesMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static ClassesMatcher create() throws ViatraQueryException {
    return new ClassesMatcher();
  }
   ...
   * 
   */
  private ClassesMatcher() throws ViatraQueryException {
