...
/**
 * Pattern-specific match representation of the eu.supersede.dynadapt.usecases.patterns.HSKVirtualExecutionEnvironments pattern,
 * to be used in conjunction with {@link HSKVirtualExecutionEnvironmentsMatcher}.
 * 
...
public abstract class HSKVirtualExecutionEnvironmentsMatch extends BasePatternMatch {
  private ExecutionEnvironment fExecEnv;
  
  private static List<String> parameterNames = makeImmutableList("execEnv");
  
  private HSKVirtualExecutionEnvironmentsMatch(final ExecutionEnvironment pExecEnv) {
  ...
  public String patternName() {
    return "eu.supersede.dynadapt.usecases.patterns.HSKVirtualExecutionEnvironments";
  }
  
  @Override
  public List<String> parameterNames() {
    return HSKVirtualExecutionEnvironmentsMatch.parameterNames;
  }
  ...
  @Override
  public HSKVirtualExecutionEnvironmentsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HSKVirtualExecutionEnvironmentsMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    HSKVirtualExecutionEnvironmentsMatch other = (HSKVirtualExecutionEnvironmentsMatch) obj;
  ...
  @Override
  public HSKVirtualExecutionEnvironmentsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static HSKVirtualExecutionEnvironmentsMatch newEmptyMatch() {
   ...
   * 
   */
  public static HSKVirtualExecutionEnvironmentsMatch newMutableMatch(final ExecutionEnvironment pExecEnv) {
   ...
   * 
   */
  public static HSKVirtualExecutionEnvironmentsMatch newMatch(final ExecutionEnvironment pExecEnv) {
    return new Immutable(pExecEnv);
  }
  
  private static final class Mutable extends HSKVirtualExecutionEnvironmentsMatch {
  ...
  private static final class Immutable extends HSKVirtualExecutionEnvironmentsMatch {
