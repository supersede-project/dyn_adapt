...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.usecases.patterns.monitors pattern,
...
public class MonitorsMatcher extends BaseMatcher<MonitorsMatch> {
  ...
  public static MonitorsMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = (MonitorsMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static MonitorsMatcher create() throws ViatraQueryException {
    return new MonitorsMatcher();
  }
   ...
   * 
   */
  private MonitorsMatcher() throws ViatraQueryException {
