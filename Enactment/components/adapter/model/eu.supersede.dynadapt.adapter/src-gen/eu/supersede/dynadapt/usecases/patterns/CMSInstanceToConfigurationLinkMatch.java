...
/**
 * Pattern-specific match representation of the eu.supersede.dynadapt.usecases.patterns.CMSInstanceToConfigurationLink pattern,
 * to be used in conjunction with {@link CMSInstanceToConfigurationLinkMatcher}.
 * 
...
public abstract class CMSInstanceToConfigurationLinkMatch extends BasePatternMatch {
  ...
  private CMSInstanceToConfigurationLinkMatch(final InstanceSpecification pLink, final InstanceSpecification pInstance) {
    this.fLink = pLink;
  ...
  public String patternName() {
    return "eu.supersede.dynadapt.usecases.patterns.CMSInstanceToConfigurationLink";
  }
  
  @Override
  public List<String> parameterNames() {
    return CMSInstanceToConfigurationLinkMatch.parameterNames;
  }
  ...
  @Override
  public CMSInstanceToConfigurationLinkMatch toImmutable() {
   ...
   * 
   */
  public static CMSInstanceToConfigurationLinkMatch newEmptyMatch() {
   ...
   * 
   */
  public static CMSInstanceToConfigurationLinkMatch newMutableMatch(final InstanceSpecification pLink, final InstanceSpecification pInstance) {
   ...
   * 
   */
  public static CMSInstanceToConfigurationLinkMatch newMatch(final InstanceSpecification pLink, final InstanceSpecification pInstance) {
    return new Immutable(pLink, pInstance);
  }
  
  private static final class Mutable extends CMSInstanceToConfigurationLinkMatch {
  ...
  private static final class Immutable extends CMSInstanceToConfigurationLinkMatch {
