...
/**
 * A match processor tailored for the eu.supersede.dynadapt.modeladapter.queries.referencesToType pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ReferencesToTypeProcessor implements IMatchProcessor<ReferencesToTypeMatch> {
  /**
  ...
  @Override
  public void process(final ReferencesToTypeMatch match) {
