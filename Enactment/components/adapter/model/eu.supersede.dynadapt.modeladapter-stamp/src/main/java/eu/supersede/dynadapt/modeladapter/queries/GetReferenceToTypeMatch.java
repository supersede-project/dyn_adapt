...
/**
 * Pattern-specific match representation of the eu.supersede.dynadapt.modeladapter.queries.getReferenceToType pattern,
 * to be used in conjunction with {@link GetReferenceToTypeMatcher}.
 * 
...
public abstract class GetReferenceToTypeMatch extends BasePatternMatch {
  ...
  private GetReferenceToTypeMatch(final Element pElement, final org.eclipse.uml2.uml.Class pType) {
  ...
  public List<String> parameterNames() {
    return GetReferenceToTypeMatch.parameterNames;
  }
  ...
  @Override
  public GetReferenceToTypeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
        return true;
    if (!(obj instanceof GetReferenceToTypeMatch)) { // this should be infrequent
        if (obj == null) {
            return false;
        }
    ...
    GetReferenceToTypeMatch other = (GetReferenceToTypeMatch) obj;
  ...
  @Override
  public GetReferenceToTypeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static GetReferenceToTypeMatch newEmptyMatch() {
   ...
   * 
   */
  public static GetReferenceToTypeMatch newMutableMatch(final Element pElement, final org.eclipse.uml2.uml.Class pType) {
   ...
   * 
   */
  public static GetReferenceToTypeMatch newMatch(final Element pElement, final org.eclipse.uml2.uml.Class pType) {
    return new Immutable(pElement, pType);
  }
  
  private static final class Mutable extends GetReferenceToTypeMatch {
  ...
  private static final class Immutable extends GetReferenceToTypeMatch {
