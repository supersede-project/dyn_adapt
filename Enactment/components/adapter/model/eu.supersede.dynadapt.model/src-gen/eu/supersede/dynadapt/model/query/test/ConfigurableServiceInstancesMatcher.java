...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.model.query.test.configurableServiceInstances pattern,
...
public class ConfigurableServiceInstancesMatcher extends BaseMatcher<ConfigurableServiceInstancesMatch> {
  ...
  public static ConfigurableServiceInstancesMatcher create() throws ViatraQueryException {
    return new ConfigurableServiceInstancesMatcher();
  }
   ...
   * 
   */
  private ConfigurableServiceInstancesMatcher() throws ViatraQueryException {
