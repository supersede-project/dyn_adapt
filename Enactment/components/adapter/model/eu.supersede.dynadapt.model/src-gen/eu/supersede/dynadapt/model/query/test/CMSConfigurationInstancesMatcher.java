...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.model.query.test.CMSConfigurationInstances pattern,
...
public class CMSConfigurationInstancesMatcher extends BaseMatcher<CMSConfigurationInstancesMatch> {
  ...
  public static CMSConfigurationInstancesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new CMSConfigurationInstancesMatcher(engine);
   ...
   * 
   */
  private CMSConfigurationInstancesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
