...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.model.query.test.nodes pattern,
...
public class NodesMatcher extends BaseMatcher<NodesMatch> {
  ...
  public static NodesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new NodesMatcher(engine);
   ...
   * 
   */
  private NodesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
