...
public final class NodeArtifactsQuerySpecification extends BaseGeneratedEMFQuerySpecification<NodeArtifactsMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "eu.supersede.dynadapt.model.query.test.nodeArtifacts";
    }
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var__virtual_1_), new EDataTypeInSlotsKey((EDataType)getClassifierLiteral("http://www.eclipse.org/uml2/5.0.0/Types", "String")));
