...
public final class ArtifactManifestationsQuerySpecification extends BaseGeneratedEMFQuerySpecification<ArtifactManifestationsMatcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "eu.supersede.dynadapt.model.query.test.artifactManifestations";
    }
      ...
      try {
          {
              ...
              new TypeConstraint(body, new FlatTuple(var__virtual_0_), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.eclipse.org/uml2/5.0.0/UML", "Manifestation")));
