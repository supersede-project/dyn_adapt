...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.modeladapter.queries.InstanceOfInstanceSpecificationLink pattern,
...
public class InstanceOfInstanceSpecificationLinkMatcher extends BaseMatcher<InstanceOfInstanceSpecificationLinkMatch> {
  ...
  public static InstanceOfInstanceSpecificationLinkMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new InstanceOfInstanceSpecificationLinkMatcher(engine);
   ...
   * 
   */
  private InstanceOfInstanceSpecificationLinkMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
