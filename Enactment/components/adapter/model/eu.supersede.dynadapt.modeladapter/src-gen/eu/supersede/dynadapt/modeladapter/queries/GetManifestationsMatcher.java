...
public class GetManifestationsMatcher extends BaseMatcher<GetManifestationsMatch> {
   ...
   * 
   */
  public Collection<GetManifestationsMatch> getAllMatches(final ExecutionEnvironment pClient, final InstanceSpecification pSupplier) {
   ...
   * 
   */
  public GetManifestationsMatch getOneArbitraryMatch(final ExecutionEnvironment pClient, final InstanceSpecification pSupplier) {
   ...
   * 
   */
  public boolean hasMatch(final ExecutionEnvironment pClient, final InstanceSpecification pSupplier) {
   ...
   * 
   */
  public int countMatches(final ExecutionEnvironment pClient, final InstanceSpecification pSupplier) {
   ...
   * 
   */
  public void forEachMatch(final ExecutionEnvironment pClient, final InstanceSpecification pSupplier, final IMatchProcessor<? super GetManifestationsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final ExecutionEnvironment pClient, final InstanceSpecification pSupplier, final IMatchProcessor<? super GetManifestationsMatch> processor) {
   ...
   * 
   */
  public GetManifestationsMatch newMatch(final ExecutionEnvironment pClient, final InstanceSpecification pSupplier) {
    return GetManifestationsMatch.newMatch(pClient, pSupplier);
  }
   ...
   * 
   */
  public Set<ExecutionEnvironment> getAllValuesOfclient(final InstanceSpecification pSupplier) {
   ...
   * 
   */
  public Set<InstanceSpecification> getAllValuesOfsupplier(final ExecutionEnvironment pClient) {
  ...
  protected GetManifestationsMatch tupleToMatch(final Tuple t) {
    try {
    	return GetManifestationsMatch.newMatch((ExecutionEnvironment) t.get(POSITION_CLIENT), (InstanceSpecification) t.get(POSITION_SUPPLIER));
  ...
  protected GetManifestationsMatch arrayToMatch(final Object[] match) {
    try {
    	return GetManifestationsMatch.newMatch((ExecutionEnvironment) match[POSITION_CLIENT], (InstanceSpecification) match[POSITION_SUPPLIER]);
    } catch(ClassCastException e) {
  ...
  protected GetManifestationsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return GetManifestationsMatch.newMutableMatch((ExecutionEnvironment) match[POSITION_CLIENT], (InstanceSpecification) match[POSITION_SUPPLIER]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
