...
/**
 * Generated pattern matcher API of the queries.classGeneralizations pattern,
...
public class ClassGeneralizationsMatcher extends BaseMatcher<ClassGeneralizationsMatch> {
  ...
  public static ClassGeneralizationsMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new ClassGeneralizationsMatcher(engine);
   ...
   * 
   */
  private ClassGeneralizationsMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
