...
/**
 * Generated pattern matcher API of the queries.instances pattern,
...
public class InstancesMatcher extends BaseMatcher<InstancesMatch> {
  ...
  public static InstancesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new InstancesMatcher(engine);
   ...
   * 
   */
  private InstancesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
