...
/**
 * Generated pattern matcher API of the queries.realizations pattern,
...
public class RealizationsMatcher extends BaseMatcher<RealizationsMatch> {
  ...
  public static RealizationsMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new RealizationsMatcher(engine);
   ...
   * 
   */
  private RealizationsMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
