...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.atos.queries.serviceConfigurations pattern,
...
public class ServiceConfigurationsMatcher extends BaseMatcher<ServiceConfigurationsMatch> {
  ...
  public static ServiceConfigurationsMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new ServiceConfigurationsMatcher(engine);
   ...
   * 
   */
  private ServiceConfigurationsMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
