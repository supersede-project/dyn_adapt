...
import eu.supersede.dynadapt.aom.dsl.common.SupersedeQualifiedNameProvider;

/**
 * This class contains static methods that support the handling of SUPERSEDE models.
 * 
 * @author Martin Fleck
 * @author Jesús Gorroñogoitia
 *
 */
public class SupersedeDSLResourceUtil {	
	private static SupersedeQualifiedNameProvider provider = new SupersedeQualifiedNameProvider();
