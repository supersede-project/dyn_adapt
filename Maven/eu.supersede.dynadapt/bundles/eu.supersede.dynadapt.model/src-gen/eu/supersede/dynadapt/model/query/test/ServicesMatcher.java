...
/**
 * Generated pattern matcher API of the eu.supersede.dynadapt.model.query.test.services pattern,
...
public class ServicesMatcher extends BaseMatcher<ServicesMatch> {
  ...
  public static ServicesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = new ServicesMatcher(engine);
   ...
   * 
   */
  private ServicesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
