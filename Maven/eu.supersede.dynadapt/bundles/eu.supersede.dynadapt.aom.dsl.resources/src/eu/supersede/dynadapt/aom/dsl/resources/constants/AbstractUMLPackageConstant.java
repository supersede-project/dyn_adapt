...
import eu.supersede.dynadapt.aom.dsl.util.ObjectUtil;


public class AbstractUMLPackageConstant extends AbstractResourceConstant {
	public static URI PACKAGE_URI;
	
	public final SupersedeDSLModelElement<Package> PACKAGE;
	...
	public AbstractUMLPackageConstant(URI uri) {
		...
		PACKAGE = new SupersedeDSLModelElement<Package>(umlPackage);
		collectDatatypes();
	}
