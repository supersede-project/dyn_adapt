...
public class MaxTimeStoppingCondition implements StoppingCondition {
	...
	/* (non-Javadoc)
	 * @see eu.supersede.dm.optimizer.gp.stoppingconditions.StoppingCondition#fitnessEvaluation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.supersede.dm.optimizer.gp.stoppingconditions.StoppingCondition#getCurrentValue()
	 */
	@Override
...
//		logger.info("Current value of time: " + currentEvaluation);
	...
	/* (non-Javadoc)
	 * @see eu.supersede.dm.optimizer.gp.stoppingconditions.StoppingCondition#getLimit()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.supersede.dm.optimizer.gp.stoppingconditions.StoppingCondition#isFinished()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see eu.supersede.dm.optimizer.gp.stoppingconditions.StoppingCondition#reset()
	 */
	@Override
	public void reset() {
		startTime = System.currentTimeMillis();
	...
	/* (non-Javadoc)
	 * @see eu.supersede.dm.optimizer.gp.stoppingconditions.StoppingCondition#setLimit(long)
	 */
	@Override
