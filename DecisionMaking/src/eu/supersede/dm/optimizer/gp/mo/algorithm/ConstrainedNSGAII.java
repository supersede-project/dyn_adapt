...
import eu.supersede.dm.optimizer.gp.mo.operators.SelectionFunction;
...
//	private int fitnessEvaluations = 0;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see eu.supersede.dm.optimizer.gp.algorithm.StandardGP#generateSolution()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see eu.supersede.dm.optimizer.gp.algorithm.StandardGP#evolve()
	 */
