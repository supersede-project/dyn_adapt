...
export JAVA_HOME=/opt/jenkins/java
export PATH=${JAVA_HOME}/bin:${PATH}

BUILD_ID=dontKillMe nohup mvn -v; mvn spring-boot:run -Drun.arguments="--server.port=8091,--logging.file=./log/dm-optimizer.log" -Dsupersede.if.properties=if.production.properties &
