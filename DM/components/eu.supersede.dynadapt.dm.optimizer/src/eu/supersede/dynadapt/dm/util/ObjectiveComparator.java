 ...
 * <code>Chromosome</code> objects) based on a objective values.
...
public class ObjectiveComparator implements Comparator {
	...
	public int compare(Object o1, Object o2) {
		...
		double objetive1 = ((Chromosome) o1).getObjective()[this.nObj];
		double objetive2 = ((Chromosome) o2).getObjective()[this.nObj];
		if (ascendingOrder_) {
