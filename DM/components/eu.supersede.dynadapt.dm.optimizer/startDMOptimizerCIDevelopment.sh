...
BUILD_ID=dontKillMe nohup mvn spring-boot:run -Drun.arguments="--server.port=8091,--logging.file=./log/dm-optimizer.log" -Dsupersede.if.properties=if.development.properties &
